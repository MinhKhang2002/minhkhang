    ...
    function updateTable(newsList) {
        ...
        $.each(newsList, function (index, news) {
            var row = "<tr>" +
                ...
                "<td>" + news.title + "</td>" +
                "<td>" + extractFirstParagraph(news.content) + "</td>" +
...
function submitForm(idToUpdate, newData) {
    ...
    var ajaxSettings = {
        ...
        success: function (result) {
            ...
            loadIndexContentByUser("Thành công!");
...
$(document).on("click", ".updateNews", function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            console.log("Categories: ",selectedCategoryCode)
...
function loadCategoriesSelect(selectedCategoryCode) {
    console.log("category: ", selectedCategoryCode)
    $.ajax({
...
function deleteNew(ids) {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            loadIndexContentByUser("Xoá thành công!");
...
function loadIndexContentByUser(message) {
    // Hiển thị loading
    showLoading()
